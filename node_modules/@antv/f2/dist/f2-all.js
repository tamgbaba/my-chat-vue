(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    // in node
    var isNode = typeof global && !typeof window;
    // in browser
    ...
    function createEvent(event, chart) {
      ...
      var points = convertPoints$1(event, canvas);
      // touchend会没有points
      var point = points[0] || {};
      return {
        type: event.type,
     ...
     * @class
     */
    var Category$1 = /** @class */function (_super) {
     ...
     * @class
     */
    var TimeCat$1 = /** @class */function (_super) {
     ...
     * @class
     */
    var Linear$1 = /** @class */function (_super) {
    ...
    var Container = {
      ...
      _getAriaLabel: function _getAriaLabel() {
        var _this$_attrs = this._attrs,
          ...
          children = _this$_attrs.children;
        // 主动关闭
        if (!aria) return;
        var childAriaLabels = [];
    ...
    */
    ...
    var TOUCH_EVENTS$1 = ['touchstart', 'touchmove', 'touchend', 'click'];
